...
def pr_exel(col_in=0, format_data='0,00', titul_list=''):
    ...
    if True:
        try:
            ...
            # ==================НЕИЗМЕНЯЕМАЯ ЧАСТЬ==========================================================
            sheet1.Range("A1:F4").HorizontalAlignment = xlCenter
            sheet1.Range("A1:F4").VerticalAlignment = xlCenter
            sheet1.Range("A1:F4").Font.Name = "Arial CYR"
            sheet1.Range("A1:F4").Font.FontStyle = "полужирный"
            sheet1.Range("A3:F4").ShrinkToFit = True
            sheet1.Range("A3:F4").WrapText = True

            sheet1.Range("A1:F2").MergeCells = True
            sheet1.Range("A1:F2").Font.Size = 14
            sheet1.Range("A1:F2").value = titul_list

            sheet1.Range("A3:F4").Font.Size = 10
            ...
            sheet1.Range("A3:F4").Borders(xlEdgeLeft).Weight = xlThin
            sheet1.Range("A3:F4").Borders(xlEdgeTop).Weight = xlThin
            sheet1.Range("A3:F4").Borders(xlEdgeBottom).Weight = xlThin
            sheet1.Range("A3:F4").Borders(xlEdgeRight).Weight = xlThin
            sheet1.Range("A3:F4").Borders(xlInsideVertical).Weight = xlThin
            sheet1.Range("A3:F4").Borders(xlInsideHorizontal).Weight = xlThin
            ...
            sheet1.Range("A3:F" + str(col_in + 4)).Borders(xlEdgeLeft).Weight = xlThin
            sheet1.Range("A3:F" + str(col_in + 4)).Borders(xlEdgeTop).Weight = xlThin
            sheet1.Range("A3:F" + str(col_in + 4)).Borders(xlEdgeBottom).Weight = xlThin
            sheet1.Range("A3:F" + str(col_in + 4)).Borders(xlEdgeRight).Weight = xlThin
            sheet1.Range("A3:F" + str(col_in + 4)).Borders(xlInsideVertical).Weight = xlThin
            ...
            sheet1.Range("C5:F" + str(col_in + 4)).HorizontalAlignment = xlRight
            sheet1.Range("C5:F" + str(col_in + 4)).VerticalAlignment = xlBottom
            sheet1.Range("C5:F" + str(col_in + 4)).ShrinkToFit = True

            sheet1.Range("D5:F" + str(col_in + 4)).NumberFormat = format_data
