...
if __name__ == '__main__':
    ...
    try:
        ...
        Count_day = ttk.Combobox(f_now, height=1, width=15, values=list1)
        ...
        Count_day1 = ttk.Combobox(f_arch, height=1, width=15, values=list1, state="disable")
